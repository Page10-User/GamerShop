...
namespace Gamer_Shop2._0.Formularios.GestionUsuario
{
    public partial class ListaUsuario : Form
    {
        ...
        private void BDescargarListUs_Click(object sender, EventArgs e)
        {
            // Mensaje de confirmación para iniciar la descarga
            MsgPersonalizado mensaje = new MsgPersonalizado("¿Está seguro que desea descargar la lista de usuarios?", "Descargar lista usuario?", "Interrogacion", null);
            ...
            if (result == DialogResult.Yes)
            {
                ...
                {
                    folderDialog.Description = "Seleccione una carpeta para guardar la lista de usuarios";
                    ...
                    if (folderDialog.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        BackupUsuarios.ExportarUsuariosACSV(rutaSeleccionada);
